...
export const growthPages: GrowthPage[] = [
  ...
  },
  {
    ...
    faq: [["Does this replace Search Console?", "No. Search Console reports real search impressions and clicks. sitescope.fyi reviews page signals that may explain implementation gaps.", "能替代 Search Console 吗？", "不能。Search Console 提供真实曝光和点击，sitescope.fyi 检查可能解释实施缺口的页面信号。"], ["Will fixing every issue guarantee rankings?", "No. Relevance, competition, indexing and many other factors affect search results.", "修完所有问题能保证排名吗？", "不能。相关性、竞争、索引等多种因素共同影响搜索结果。"]], related: "seo-vs-geo",
  },
  {
