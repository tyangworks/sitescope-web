...
const guides = [
  ...
  },
  {
    ...
    sections: [
      ...
      ["Should I buy a separate GEO plan?", "Not necessarily. sitescope.fyi includes SEO and GEO under Search Visibility in the same Free and Pro plans. Choose implementation help based on the work required, not the number of acronyms on a proposal.", "需要单买 GEO 套餐吗？", "不一定。sitescope.fyi 在同一免费和 Pro 套餐的搜索可见性中包含 SEO 和 GEO。根据实际实施工作选择帮助，不以提案缩写数量判断价值。"],
    ],
  },
  {
