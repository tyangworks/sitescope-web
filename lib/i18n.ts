...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      heroTitle: "Find What's Hurting Your",
      heroAccent: "Website Growth",
      heroSubtitle:
        "Audit visibility, performance, content, and conversions across traditional search (SEO) and AI search (GEO). Get a prioritized fix plan.",
      ...
      painPointsTitle: "Website growth can break at every stage — discovery, experience, messaging and conversion.",
      painPointsSubtitle: "",
      painPointSpeed: "Slow pages can prevent visitors from reaching your offer.",
      painPointSeo: "SEO and AI-search gaps can reduce your website's search visibility.",
      ...
      pricingProTitle: "Pro",
      pricingProDesc: "Detailed website growth audit covering SEO, AI search (GEO), performance, content and conversion — with evidence, a prioritized fix plan, implementation steps and code snippets.",
      ...
      howStepAiDesc: "We analyze Search Visibility (SEO + GEO), performance, content and conversion signals.",
    ...
    report: {
      ...
      overallScore: "Overall Growth Score",
      ...
      proAuditOverview: "Prioritized Growth Findings",
      proAuditSubtitle: "Search Visibility (SEO + GEO), performance, content and conversion. Findings describe the observed page, not measured rankings.",
      seoAudit: "Traditional Search (SEO)",
      geoAudit: "AI Search Readiness (GEO)",
      findings: "findings",
      evidence: "Evidence",
  ...
  zh: {
    ...
    home: {
      ...
      heroAccent: "增长的问题",
      heroSubtitle:
        "审计网站的搜索可见性、性能、内容和转化，覆盖传统搜索（SEO）与 AI 搜索（GEO），明确优先修复计划。",
    ...
    report: {
      ...
      processing: "处理中...",
      proAuditOverview: "按优先级排列的增长发现",
      proAuditSubtitle: "搜索可见性（SEO + GEO）、性能、内容与转化。发现来自页面观察，不是实际排名。",
      seoAudit: "传统搜索（SEO）",
      geoAudit: "AI 搜索就绪度（GEO）",
      findings: "项发现",
      evidence: "检测证据",
      whyItMatters: "为什么重要",
