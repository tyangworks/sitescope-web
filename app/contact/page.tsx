...
async function parseJsonSafe(response: Response) {
  ...
  if (!contentType.includes("application/json")) {
    throw new Error("Contact service is not available yet. Please try again after deployment.");
  }
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={() => {
                    const normalized = normalizeUrlInput(formData.website);
                    if (normalized.url) {
                      setFormData({ ...formData, website: normalized.url });
                    }
                  }}
                  onChange={(e) =>
