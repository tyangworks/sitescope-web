...
const copy = {
  en: {
    ...
    services: [
      { id: "ai-website-audit", title: "Website Growth Audit", tagline: "Discover the problems.", description: "Find the Search Visibility (SEO + GEO), performance, content and conversion issues holding your website back.", points: ["Evidence-based website growth diagnosis", "SEO + GEO, performance, content and conversion review", "Clear priorities instead of guesswork"], cta: "Start with a free audit", href: "/" },
