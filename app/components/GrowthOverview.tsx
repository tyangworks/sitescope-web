  ...
  return <section className="border-y border-gray-800 px-6 py-14">
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-12 border-t border-gray-800 pt-8">
        ...
        <p className="mt-4 max-w-3xl leading-relaxed text-gray-400">{zh ? "浏览器抓取页面结构、SEO、AI 搜索就绪度、内容和转化线索，AI 再解释观察。新版综合分按公开权重和固定规则计算，未测量维度不扣分。单页分析不代表真实用户性能、全站覆盖、真实转化率或 AI 排名。" : "A browser crawl captures structure, SEO, AI-search readiness, content, and conversion signals. AI explains the observations. New overall scores use explicit weights and fixed rules; unmeasured dimensions are excluded. A single-page audit does not measure real-user performance, full-site coverage, conversion rates, or AI rankings."}</p>
