    ...
    <main className="min-h-screen bg-[#0B0F1A] text-white">
      ...
      <article>
        ...
        <div className="mx-auto max-w-4xl px-6 py-14 md:py-20">
          ...
          {article.eyebrow === "AI Search / GEO" && <aside className="mt-10 border-t border-gray-800 pt-6 text-sm text-gray-400"><h2 className="font-semibold">{language === "zh" ? "进一步阅读：官方指南" : "Further reading: official guidance"}</h2><ul className="mt-3 space-y-2"><li><a className="text-blue-300 underline" href="https://developers.google.com/search/docs/fundamentals/ai-optimization-guide">Google Search: AI optimization guidance</a></li><li><a className="text-blue-300 underline" href="https://developers.google.com/search/docs/appearance/structured-data/sd-policies">Google Search: structured data guidelines</a></li></ul></aside>}
        </div>
