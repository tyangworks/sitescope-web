...
export const zhArticles: ContentArticle[] = [
  ...geoArticles(true),
  {
    ...
    sections: [
      ...
      { type: "comparison", heading: "猜测与洞察的区别", leftLabel: "凭感觉猜测", rightLabel: "sitescope.fyi", rows: [["随意修改", "数据驱动的洞察"], ["不断试错", "清晰的优先级"], ["进展缓慢", "更快完成改进"]] },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "simple", heading: "这正是 sitescope.fyi 所做的", paragraphs: ["我们分析你的网站，告诉你哪里有问题、为什么重要，以及应该如何修复。", "不再猜测，只有清晰的答案。"] },
    ],
